...
# Regras para Tokens de Operadores (strings fixas)
...
# Regras Complexas (funções - ordem importa no PLY)
...
def t_ID(t):
    ...
    if t.type == 'ID':
        # Na linguagem, identificadores soltos não são válidos.
...
# Rastreador de linhas e caracteres ignorados
def t_newline(t):
    r'\n+'
